          ...
          <table className="mb-3 w-full">
            <thead>
              <tr>
                ...
                <th colSpan={2} className="border-b border-zinc-300 px-2 py-3 text-xs tracking-wide leading-none text-center font-medium text-zinc-400 w-[10%]">
                  Aksi
                </th>
              </tr>
            </thead>
              ...
              {mahasiswaPengembalianData?.data?.data?.length > 0 ? (
                ...
                <tr>
                  <td colSpan={7} className="p-2 border text-xs text-center">
                    Tidak ada barang dikembalikan yang telah disetujui
                  </td>
                </tr>
              )}
            </tbody>
